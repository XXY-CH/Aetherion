...
- Serialize event appends with a workspace-local lock, recover stale locks with Unix owner-PID checks plus age fallback, write through synced temp files and atomic rename, clean abandoned temp files on startup, and reject corrupt hash chains.
