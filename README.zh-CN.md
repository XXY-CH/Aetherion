...
- `schemas/`：Event、Tool Request、Policy Decision、Scoped Lease、Action Record、Observation Record、Verification Record、Consent Record、Permission Policy、Memory、Agent Runtime、Model Request/Response、Response Audit、Tool Request Proposal、Capability、Replay、Release Manifest、Local Ingress Readiness、Local Ingress Rate Limit Reservation、Local Ingress Idempotency Reservation、Local Ingress Idempotency Completion、metadata-only Vault Reference、Vault Policy Binding、Model Provider Readiness 和 Supervisor Lifecycle Readiness 等 JSON Schema。
