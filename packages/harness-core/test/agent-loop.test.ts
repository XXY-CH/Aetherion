...
test("tool registry registers local_file_read, local_file_write, search_files, shell_exec, web_fetch, agent_spawn, and file_edit and converts to provider formats", () => {
  ...
  assert.ok(registry.has("search_files"));
