...
export type SupervisorRpcRequest = {
  id: string;
  method: "workspace.init" | "event.append" | "run.resume.evaluate" | "security.taint.evaluate" | "surface.outbox.evaluate" | "tool.evaluate" | "lease.issue" | "file.read" | "file.read.traced" | "child.file.read" | "file.write.prepare" | "file.write.commit" | "trace.replay";
