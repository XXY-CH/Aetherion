...
- Rust policy and leases: `tool.evaluate`, `lease.issue`, `file.read`, `file.write.prepare`, `file.write.commit`; legacy direct `file.write` is rejected.
